...
$mailbox = new Mailbox('{imap.gmail.com:993/imap/ssl}INBOX', 'xxx@xxx.xx', 'xxx', 'xxx');
$mails = array();
// print_r($mails);echo"<p>";
$mailsIds = $mailbox->searchMailBox('ALL');
// Filter nach Absender 
// $mailsIds = $mailbox->searchMailBox('FROM "turnierueberwachung@drbv.de"');
// $mailsIds = $mailbox->searchMailBox('TO "turnierueberwachung@drbv.de"');
// Filter nach Betreff  $mailsIds = $mailbox->searchMailBox('SUBJECT "ggg"');
// echo"mailsIds = "; print_r($mailsIds);echo"<br>";
if(!$mailsIds) {
...
$mailbox->deleteMail($mailId);
 ...
 header("Location: ./mailanhaenge/entpackt/unzip.php");
?>