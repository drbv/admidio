...
if($_GET['file'])
{
$dir = '../../adm_my_files/download/Turniermusik/Unzertifizierte-Musik/';
...
$sqlab = "SELECT * FROM zertifizierungen ORDER BY last_update DESC";
   ...
   if($temp['erledigt'] == $_SESSION['anzeige'])
    {
     ...
     if(is_file('../../adm_my_files/download/Turniermusik/Unzertifizierte-Musik/' . $temp['titel']))
        echo'<td width="270"><a href="index.php?file=' . $temp['titel'] .'">' . $temp['titel'] . '</td>';
     else 
...
if($_POST['absenden'])
       {
         ...
         $sqlab = "update zertifizierungen set ";
         ...
         $sqlab = "SELECT * FROM zertifizierungen WHERE id = '" . $_POST['id_auswahl'] . "'";
         ...
         if($ergebnis['g1_musik'] == 'io')
           {
            ...
            $sqlab = "update zertifizierungen set gutachter1_ok = '1' WHERE id = '" . $_POST['id_auswahl'] . "'";
            mysqli_query($db, $sqlab);
           }
         if($ergebnis['g1_musik'] != 'io' && $ergebnis['g1_musik'] != '---') 
           {
            $zaehler_nio = $zaehler_nio + 1;
            $sqlab = "update zertifizierungen set gutachter1_ok = '2' WHERE id = '" . $_POST['id_auswahl'] . "'";
            mysqli_query($db, $sqlab);
           } 
         ...
         if($ergebnis['g2_musik'] == 'io')
           {
            $zaehler_io = $zaehler_io + 1;
            $sqlab = "update zertifizierungen set gutachter2_ok = '1' WHERE id = '" . $_POST['id_auswahl'] . "'";
            mysqli_query($db, $sqlab);
           } 
         if($ergebnis['g2_musik'] != 'io' && $ergebnis['g2_musik'] != '---') 
           {
            $zaehler_nio = $zaehler_nio + 1;
            $sqlab = "update zertifizierungen set gutachter2_ok = '2' WHERE id = '" . $_POST['id_auswahl'] . "'";
            mysqli_query($db, $sqlab);
           } 
         ...
         if($ergebnis['g3_musik'] == 'io')
           {
            $zaehler_io = $zaehler_io + 1;
            $sqlab = "update zertifizierungen set gutachter3_ok = '1' WHERE id = '" . $_POST['id_auswahl'] . "'";
            mysqli_query($db, $sqlab);
           } 
         if($ergebnis['g3_musik'] != 'io' && $ergebnis['g3_musik'] != '---') 
           {
            $zaehler_nio = $zaehler_nio + 1;
            $sqlab = "update zertifizierungen set gutachter3_ok = '2' WHERE id = '" . $_POST['id_auswahl'] . "'";
            mysqli_query($db, $sqlab);
           } 
