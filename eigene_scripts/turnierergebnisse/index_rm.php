...
$sqlab = 'SELECT * FROM rundentab WHERE turniernummer = ' . $_SESSION["turnier_auswahl"] . ' ORDER BY runden_rf';
$temp = mysqli_query($db, $sqlab);
unset($i);
...
while($t_runden = mysqli_fetch_array($temp))
      {
       $i = $i + 1;
       $t_runde[$i] = $t_runden;  
       //  echo $t_runde[$i][1] . ' 1  ' . $t_runde[$i][3] . ' 3 ' . $t_runde[$i][4] ;echo" 4<br>";    
      }      
...
echo'<td width="35"><p class="vertical-text_bw">Tanzfiguren (Komplexe, Highlight)</p></td><td width="35"><p class="vertical-text_bw">&nbsp</p></td>';
...
echo'<td width="35"><p class="vertical-text_bw">Dance Performance</p></td><td width="35"><p class="vertical-text_bw">&nbsp</p></td>';
...
echo'<td width="35"><p class="vertical-text_bw">&nbsp</p></td><td width="35"><p class="vertical-text_bw">&nbsp</p></td>';
echo'<td width="35"><p class="vertical-text_bw">&nbsp</p></td><td width="35"><p class="vertical-text_bw">&nbsp</p></td>';
echo'<td width="35"><p class="vertical-text_bw">&nbsp</p></td></tr>';
}
if(($_SESSION["startklasse"] == "BW_MA" || $_SESSION["startklasse"] == "BW_MB" || $_SESSION["startklasse"] == "BW_SA" || $_SESSION["startklasse"] == "BW_SB" || $_SESSION["startklasse"] == "BW_JA") && $ausgabe == 1)
{
echo'<table width="1500" border=1 cellspacing="2" cellpadding="3">';
...
echo'<tr><td align="right" colspan="10">Vorrunde gemeldet:</td><td class="grau" align="center">' . $gemeldete_akros[15] . '</td><td class="grau" align="center" colspan="2">' . utf8_encode($gemeldete_akros[14]) . '</td><td align="center">' . $gemeldete_akros[17] . '</td><td align="center" colspan="2">' . utf8_encode($gemeldete_akros[16]) . '</td><td class="grau" align="center">' . $gemeldete_akros[19] . '</td><td class="grau" align="center" colspan="2">' . utf8_encode($gemeldete_akros[18]) . '</td><td align="center">' . $gemeldete_akros[21] . '</td><td align="center" colspan="2">' . utf8_encode($gemeldete_akros[20]) . '</td><td class="grau" align="center">' . $gemeldete_akros[23] . '</td><td class="grau" align="center" colspan="2">' . utf8_encode($gemeldete_akros[22]) . '</td><td align="center">' . $gemeldete_akros[25] . '</td><td align="center" colspan="2">' . utf8_encode($gemeldete_akros[24]) . '</td><td class="grau" align="center">' . $gemeldete_akros[27] . '</td><td class="grau" align="center" colspan="2">' . utf8_encode($gemeldete_akros[26]) . '</td><td align="center">' . $gemeldete_akros[29] . '</td><td "align="center" colspan="2">' . utf8_encode($gemeldete_akros[28]) . '</td></tr>';

echo'<tr><td align="right" colspan="10">Zwischenrunde gemeldet:</td><td class="grau" align="center">' . $gemeldete_akros[31] . '</td><td class="grau" align="center" colspan="2">' . utf8_encode($gemeldete_akros[30]) . '</td><td align="center">' . $gemeldete_akros[33] . '</td><td align="center" colspan="2">' . utf8_encode($gemeldete_akros[32]) . '</td><td class="grau" align="center">' . $gemeldete_akros[35] . '</td><td class="grau" align="center" colspan="2">' . utf8_encode($gemeldete_akros[34]) . '</td><td align="center">' . $gemeldete_akros[37] . '</td><td align="center" colspan="2">' . utf8_encode($gemeldete_akros[36]) . '</td><td class="grau" align="center">' . $gemeldete_akros[39] . '</td><td class="grau" align="cent class="grau"er" colspan="2">' . utf8_encode($gemeldete_akros[38]) . '</td><td align="center">' . $gemeldete_akros[41] . '</td><td align="center" colspan="2">' . utf8_encode($gemeldete_akros[40]) . '</td><td class="grau" align="center">' . $gemeldete_akros[43] . '</td><td class="grau" align="center" colspan="2">' . utf8_encode($gemeldete_akros[42]) . '</td><td align="center">' . $gemeldete_akros[45] . '</td><td align="center" colspan="2">' . utf8_encode($gemeldete_akros[44]) . '</td></tr>';


echo'<tr><td align="right" colspan="10">Endrunde gemeldet:</td><td class="grau" align="center">' . $gemeldete_akros[47] . '</td><td class="grau" align="center" colspan="2">' . utf8_encode($gemeldete_akros[46]) . '</td><td align="center">' . $gemeldete_akros[49] . '</td><td align="center" colspan="2">' . utf8_encode($gemeldete_akros[48]) . '</td><td class="grau" align="center">' . $gemeldete_akros[51] . '</td><td class="grau" align="center" colspan="2">' . utf8_encode($gemeldete_akros[50]) . '</td><td align="center">' . $gemeldete_akros[53] . '</td><td align="center" colspan="2">' . utf8_encode($gemeldete_akros[52]) . '</td><td class="grau" align="center">' . $gemeldete_akros[55] . '</td><td class="grau" align="center" colspan="2">' . utf8_encode($gemeldete_akros[54]) . '</td><td align="center">' . $gemeldete_akros[57] . '</td><td align="center" colspan="2">' . utf8_encode($gemeldete_akros[56]) . '</td><td class="grau" align="center">' . $gemeldete_akros[59] . '</td><td class="grau" align="center" colspan="2">' . utf8_encode($gemeldete_akros[58]) . '</td><td align="center">' . $gemeldete_akros[61] . '</td><td align="center" colspan="2">' . utf8_encode($gemeldete_akros[60]) . '</td></tr>';
}
// Wertungen für Tanzpaar in Datenbank suchen 

  //$sqlab = 'SELECT * FROM wertungen WHERE turniernummer = ' . $_SESSION["turnier_auswahl"] . ' AND  paar_id_tlp = ' . $_SESSION["paar_id"] . ' ORDER BY rund_tab_id, wert_id'; 
