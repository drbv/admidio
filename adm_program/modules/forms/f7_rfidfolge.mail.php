<?php
/******************************************************************************
 * Form for RFID Folgebestellung Mail
 *
...
if (isset($_POST)) {
  $strMailtextMod = "";
  $strMailtextMod .= "Formular - RFID Folgebestellung (nach Verlust): ".$_POST['Startbuch']."\n\n\n";
  ...
  $strMailtextMod .= "\n";  
  $strMailtextMod .= "RFID für: ".$strDelimiter1.": ".$_POST['rfid']."\n";  
  $strMailtextMod .= "\n";  
  }
