...
echo '         <form name="Formular" action="'.$g_root_path.'/adm_program/modules/forms/mail_send.php?form_id=2" method="post" autocomplete="off" accept-charset="UTF-8" onsubmit="return chkFormular()">
                  <!-- Hier die eigentlichen Formularfelder eintragen. Die folgenden sind Beispielangaben. -->                  
                  <font face="Verdana" size="3" color="#000080">
                  <h3>&nbsp;Änderung der Vereinsmail</h3>
                  <br />
                  <fieldset>
                  ...
                  <br />
                  <fieldset>
                    <legend>Angaben zur Mailänderung</legend>
                    <table>
                      <tr>
                        <td>Bestehende Mailadresse:</td>
                        <td><input type="text" name="Vereinsmail" value="'.$user->getValue('EMAIL').'" size="50" readonly="readonly"></td>
                      </tr>
                      <tr>
                        <td>Neue Mailadresse:</td>
                        <td><input required type="text" name="VereinsmailNeu" tabindex="4" size="50"><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span></td>
                      </tr>
                    </table>    
                  </fieldset>
                  <br />
