...
//$strEmpfaenger2  = 'forms4gs2portal@drbv.de';
//$strEmpfaenger2  = 'geschaeftsstelle@drbv.de';
$strEmpfaenger2  = 'ruediger.menken@drbv.de';
...
if ($getFormId=='2') {
  require(SERVER_PATH. '/adm_program/modules/forms/f2_vereinsmail.mail.php');
}
if ($getFormId=='3') {
  require(SERVER_PATH. '/adm_program/modules/forms/f3_vereinsgeodaten.mail.php');
}
if ($getFormId=='4') {
  require(SERVER_PATH. '/adm_program/modules/forms/f4_turnierbewerbung.mail.php');
}
if ($getFormId=='5') {
  require(SERVER_PATH. '/adm_program/modules/forms/f5_turnieranmeldung.mail.php');
}  
if ($getFormId=='6') {
  require(SERVER_PATH. '/adm_program/modules/forms/f6_startbuchneu.mail.php');
}
if ($getFormId=='7') {
  require(SERVER_PATH. '/adm_program/modules/forms/f7_rfidfolge.mail.php');
}   
if ($getFormId=='8') {
  require(SERVER_PATH. '/adm_program/modules/forms/f8_startbuchaddr.mail.php');
}   
if ($getFormId=='9') {
  require(SERVER_PATH. '/adm_program/modules/forms/f9_startbuch_ungueltig.mail.php');
} 
if ($getFormId=='10') {
  require(SERVER_PATH. '/adm_program/modules/forms/f10_startmarken.mail.php');
} 
if ($getFormId=='11') {
  require(SERVER_PATH. '/adm_program/modules/forms/f11_sporttauglichkeit.mail.php');
} 
if ($getFormId=='12') {
  require(SERVER_PATH. '/adm_program/modules/forms/f12_startbuchaufstieg.mail.php');
} 
if ($getFormId=='13') {
  require(SERVER_PATH. '/adm_program/modules/forms/f13_turnierreservierung.mail.php');
} 
if ($getFormId=='14') {
  require(SERVER_PATH. '/adm_program/modules/forms/f14_vereinswechsel.mail.php');
} 
if ($getFormId=='15') {
  require(SERVER_PATH. '/adm_program/modules/forms/f15_bspstartbuch.mail.php');
}
if ($getFormId=='16') {
...
if ($_POST['EMail']){
  ...
  //$mail2verein->setSubject($strSubjectBestNomail);
  $mail2verein->setSubject($strSubjectBest);
}
...
$mail2return->setText($strMailtextBest.$strMailtextMod);
$mail2verein->setText($strMailtextBest.$strMailtextMod);
