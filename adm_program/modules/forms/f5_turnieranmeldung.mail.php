<?php
/******************************************************************************
 * Form for Turnieranmeldung Mail
 *
...
if (isset($_POST)) {
  $strMailtextMod = "";
  $strMailtextMod .= "Formular - Turnieranmeldung: \n\n\n";
  ...
  $strMailtextMod .= "----\n";  
  $strMailtextMod .= "Name".$strDelimiter1.": ".$_POST['VeranstaltungName']."\n";  
  ...
  $strMailtextMod .= "----\n";  
  if($_POST['Meisterschaft']){$strMailtextMod .= $_POST['Meisterschaft']."\n";};
  if($_POST['OffenesTurnier']){$strMailtextMod .= $_POST['OffenesTurnier']."\n";};  
  if($_POST['Einladungsturnier']){$strMailtextMod .= $_POST['Einladungsturnier']."\n";};  
  ...
  if($_POST['national']){$strMailtextMod .= $_POST['national']."\n";};  
  if($_POST['international']){$strMailtextMod .= $_POST['international']."\n";};  
  $strMailtextMod .= "\n";
  $strMailtextMod .= "\n";
  ...
  $strMailtextMod .= "----\n";  
  $strMailtextMod .= "Turnierleiter".$strDelimiter1.": ".$_POST['Turnierleiter']."\n";  
  $strMailtextMod .= "Wird Videogebühr erhoben: ";
  if($_POST['KeineVideoGebühr']){$strMailtextMod .= "Nein";}else{$strMailtextMod .= "Ja";}                  
  $strMailtextMod .= "\n";
