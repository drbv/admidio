<?php
/******************************************************************************
 * Form for Startbuchneubestellung
 *
...
echo '         <form name="Startbuchneubestellung" id="formSwitcher" method="post" autocomplete="off" accept-charset="UTF-8">
                  
                 <font face="Verdana" size="3" color="#000080">
                 <h3>&nbsp;Startbuch/Startkarten Erstbestellung</h3>
                 <br />
                 <fieldset>
                   <legend>Erstbestellung für</legend>               
                     <select name="Erstbestellung" id="wechsler">
                 ...
                 <div id="sel_stb_sjcba" class="hideMe">
                   <form name="Startbuchbestellung1" action="'.$g_root_path.'/adm_program/modules/forms/mail_send.php?form_id=6" method="post" autocomplete="off" accept-charset="UTF-8" enctype="multipart/form-data" onsubmit="return chkFormular()">                 
                     ...
                     <table>
                       ...
                       <tr>
                         ...
                         <td>
                           ...
                           <input required type="text" name="OrtHr" tabindex="9" size="43"><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span>
                         </td>
                       </tr>  
                       <tr>
                         <td>Geburtsdatum:</td>
                         ...
                         <input type="text" id="IdGebHr" name="GebHr" tabindex="10" size="10" maxlength="10" value=""><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span>
                       ...
                       <script type="text/javascript"><!--
                         ...
                         $("#Versender").focus();
                         $(".admLinkAddFotoHr").css("cursor", "pointer");
                         // add new line to add new attachment to this mail
                         $(".admLinkAddFotoHr").click(function () {
                           newFotoHr = document.createElement("input");
                           $(newFotoHr).attr("required", true);
                           $(newFotoHr).attr("type", "file");
                           $(newFotoHr).attr("name", "userfile[]");
                           $(newFotoHr).css("display", "block");
                           $(newFotoHr).css("width", "90%");
                           $(newFotoHr).css("margin-bottom", "5px");
                           $(newFotoHr).hide();
                           $("#admAddFotoHr").before(newFotoHr);
                           //$(newFotoHr).show("slow");
                         });
                        });   
                       //--></script>                         
                       <tr>
                         <td>Passfoto:
                           <a rel="colorboxHelp" href="'. $g_root_path. '/adm_program/system/msg_window.php?message_id=DRBV_FOTO_INF&amp;inline=true"><img 
                             onmouseover="ajax_showTooltip(event,\''.$g_root_path.'/adm_program/system/msg_window.php?message_id=DRBV_FOTO_INF\',this)" onmouseout="ajax_hideTooltip()"
                             class="iconHelpLink" src="'. THEME_PATH. '/icons/info.png" alt="Info" title="" /></a><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span>
                         </td>
                         <td>                                                      
                           <a rel="colorboxHelp" href="'. $g_root_path. '/adm_program/system/msg_window.php?message_id=MAI_MAX_FOTO_SIZE&amp;message_var1='. Email::getMaxAttachementSize('mb').'&amp;inline=true"><img 
                              onmouseover="ajax_showTooltip(event,\''.$g_root_path.'/adm_program/system/msg_window.php?message_id=MAI_MAX_FOTO_SIZE&amp;message_var1='. Email::getMaxAttachementSize('mb').'\',this)" onmouseout="ajax_hideTooltip()"
                              class="iconHelpLink" src="'. THEME_PATH. '/icons/help.png" alt="Help" title="" /></a>
                           <span id="admAddFotoHr" class="iconTextLink" style="display: block;"></span>  
                         </td>
                       </tr>                         
                       <tr>
                      ...
                      <table>
                       ...
                       <tr>
                        ...
                        <td>
                          ...
                          <input required type="text" name="OrtDa" tabindex="19" size="43"><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span>
                        </td>
                       </tr>  
                       <tr>
                        <td>Geburtsdatum:</td>
                        <td>
                          ...
                          <input type="text" id="IdGebDa" name="GebDa" tabindex="20" size="10" maxlength="10" value=""><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span>
                       ...
                       <script type="text/javascript"><!--
                         $(document).ready(function() {
                         $("#Versender").focus();
                         $(".admLinkAddFotoDa").css("cursor", "pointer");
                         // add new line to add new attachment to this mail
                         $(".admLinkAddFotoDa").click(function () {
                           newFotoDa = document.createElement("input");
                           $(newFotoDa).attr("required", true);
                           $(newFotoDa).attr("type", "file");
                           $(newFotoDa).attr("name", "userfile[]");
                           $(newFotoDa).css("display", "block");
                           $(newFotoDa).css("width", "90%");
                           $(newFotoDa).css("margin-bottom", "5px");
                           $(newFotoDa).hide();
                           $("#admAddFotoDa").before(newFotoDa);
                           $(newFotoDa).show("slow");
                         });
                        });   
                       //--></script>                         
                       <tr>
                         ...
                         <td>
                           <input type="hidden" name="FotoDa" value="' . ($gPreferences['max_email_attachment_size'] * 1024) . '" />
                           <a rel="colorboxHelp" href="'. $g_root_path. '/adm_program/system/msg_window.php?message_id=MAI_MAX_FOTO_SIZE&amp;message_var1='. Email::getMaxAttachementSize('mb').'&amp;inline=true"><img 
                              onmouseover="ajax_showTooltip(event,\''.$g_root_path.'/adm_program/system/msg_window.php?message_id=MAI_MAX_FOTO_SIZE&amp;message_var1='. Email::getMaxAttachementSize('mb').'\',this)" onmouseout="ajax_hideTooltip()"
                              class="iconHelpLink" src="'. THEME_PATH. '/icons/help.png" alt="Help" title="" /></a>
                           <span id="admAddFotoDa" class="iconTextLink" style="display: float;"></span>  
                         </td>
                       </tr>
                      <tr>
                        <td>Datum Sporttauglichkeit:
                 ...
                 <form name="Startbuchbestellung2" action="'.$g_root_path.'/adm_program/modules/forms/mail_send.php?form_id=6" method="post" autocomplete="off" accept-charset="UTF-8" onsubmit="return chkFormular()">
                   <!-- Hier die eigentlichen Formularfelder eintragen. -->                  
                   <font face="Verdana" size="3" color="#000080">
                   <fieldset>
                     <legend>Absender Informationen</legend>
                     ...
                     <table>
                       ...
                       <tr>
                         ...
                         <td>
                           ...
                           <input required type="text" name="OrtFo" tabindex="24" size="43"><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span>
                         </td>
                       </tr>
                       <tr>
                         <td>Mailadresse:</td>
                ...
                <form name="Startbuchbestellung3" action="'.$g_root_path.'/adm_program/modules/forms/mail_send.php?form_id=6" method="post" autocomplete="off" accept-charset="UTF-8" enctype="multipart/form-data" onsubmit="return chkFormular()">
                  <!-- Hier die eigentlichen Formularfelder eintragen. -->        
                  <font face="Verdana" size="3" color="#000080">
                  <fieldset>
                    <legend>Absender Informationen</legend>
                  ...
                  <fieldset>
                   ...
                   <table>
                     ...
                     <input required type="text" name="OrtHr" tabindex="33" size="43"><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span>
                       </td>
                     </tr>  
                     <tr>
                       <td>Geburtsdatum:</td>
                     ...
                     <script type="text/javascript"><!--
                         ...
                         $(".admLinkAddFotoHr").css("cursor", "pointer");
                         // add new line to add new attachment to this mail
                         $(".admLinkAddFotoHr").ready(function () {
                           newFotoHr = document.createElement("input");
                           $(newFotoHr).attr("required", true);
                           $(newFotoHr).attr("type", "file");
                           $(newFotoHr).attr("name", "userfile[]");
                           $(newFotoHr).css("display", "block");
                           $(newFotoHr).css("width", "91%");
                           $(newFotoHr).css("margin-bottom", "5px");
                           $(newFotoHr).show();
                           $("#admAddFotoHr").before(newFotoHr);
                           $(newFotoHr).show("slow");
                       ...
                       <tr>
                         ...
                         <td>
                           <input required type="hidden" name="FotoHr" value="' . ($gPreferences['max_email_attachment_size'] * 1024) . '" />
                           <a rel="colorboxHelp" href="'. $g_root_path. '/adm_program/system/msg_window.php?message_id=MAI_MAX_FOTO_SIZE&amp;message_var1='. Email::getMaxAttachementSize('mb').'&amp;inline=true"><img 
                              onmouseover="ajax_showTooltip(event,\''.$g_root_path.'/adm_program/system/msg_window.php?message_id=MAI_MAX_FOTO_SIZE&amp;message_var1='. Email::getMaxAttachementSize('mb').'\',this)" onmouseout="ajax_hideTooltip()"
                              class="iconHelpLink" src="'. THEME_PATH. '/icons/help.png" alt="Help" title="" /></a>
                           <span id="admAddFotoHr" class="iconTextLink" style="display: float;"></span>  
                         </td>
                       </tr>                                      
                     <tr>
                       <td>Mailadresse:</td>
                ...
                <form name="Startbuchbestellung4" action="'.$g_root_path.'/adm_program/modules/forms/mail_send.php?form_id=6" method="post" autocomplete="off" accept-charset="UTF-8" enctype="multipart/form-data" onsubmit="return chkFormular()">
                  <!-- Hier die eigentlichen Formularfelder eintragen. -->      
                  <font face="Verdana" size="3" color="#000080">
                  <fieldset>
                    <legend>Absender Informationen</legend>
                    <table>
                      <tr>
                        <td width="30%">Ihr Name:</td>
                        <td><input required type="text" name="Versender" tabindex="39" size="50"><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span></td>
                      </tr>
                      <tr>
                        <td>Ihre Mailadresse:</td>
                  ...
                  <br />
                   <fieldset>
                    ...
                    <table>
                     <tr>
                       <td width="40%">Name:</td>
                       <td><input required required type="text" name="NameDa" tabindex="41" size="55"><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span></td>
                     </tr>
                     <tr>
                       <td>Vorname:</td>
                     ...
                     <tr>
                       ...
                       <td>
                         ...
                         <input required type="text" name="OrtDa" tabindex="45" size="43"><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span>
                       </td>
                     </tr>  
                     <tr>
                       <td>Geburtsdatum:</td>
                     ...
                     <script type="text/javascript"><!--
                         ...
                         $(".admLinkAddFotoDa").css("cursor", "pointer");
                         // add new line to add new attachment to this mail
                         $(".admLinkAddFotoDa").ready(function () {
                           newFotoDa = document.createElement("input");
                           $(newFotoDa).attr("required", true);
                           $(newFotoDa).attr("type", "file");
                           $(newFotoDa).attr("name", "userfile[]");
                           $(newFotoDa).css("display", "float");
                           $(newFotoDa).css("width", "90%");
                           $(newFotoDa).css("margin-bottom", "5px");
                           $(newFotoDa).show();
                           $("#admAddFotoDa").before(newFotoDa);
                       ...
                       <tr>
                         ...
                         <td>
                           ...
                           <a rel="colorboxHelp" href="'. $g_root_path. '/adm_program/system/msg_window.php?message_id=MAI_MAX_FOTO_SIZE&amp;message_var1='. Email::getMaxAttachementSize('mb').'&amp;inline=true"><img 
                              onmouseover="ajax_showTooltip(event,\''.$g_root_path.'/adm_program/system/msg_window.php?message_id=MAI_MAX_FOTO_SIZE&amp;message_var1='. Email::getMaxAttachementSize('mb').'\',this)" onmouseout="ajax_hideTooltip()"
                              class="iconHelpLink" src="'. THEME_PATH. '/icons/help.png" alt="Help" title="" /></a>
                           <span id="admAddFotoDa" class="iconTextLink" style="display: block;"></span>                             
                         </td>
                       </tr>
                     <tr>
                       <td>Mailadresse:</td>
