<?php
/******************************************************************************
 * Form for Startbuch ungültig Mail
 *
...
if (isset($_POST)) {
  $strMailtextMod = "";
  $strMailtextMod .= "Formular - Startbuch ungültig:\n\n\n";
  ...
  $strMailtextMod .= "\n";
  $strMailtextMod .= "Folgende Startbücher/Startkarten bitte ungültig erklären:\n\n";
  $strMailtextMod .= $StartbuchInvalidString;
  $strMailtextMod .= "\n";
