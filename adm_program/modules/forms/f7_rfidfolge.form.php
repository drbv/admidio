...
echo '         <form name="RFID-Karten Folgebestellung" id="formSwitcher" autocomplete="off" method="post" accept-charset="UTF-8">';
                 echo'  
                 <font face="Verdana" size="3" color="#000080">
                 <h3>&nbsp;RFID-Karten Folgebestellung (nach Verlust)</h3>
                 <br />
                 <fieldset>
               ...
               foreach ($member_array as $memberrow) {
                 ...
                 echo '
                   ...
                   <fieldset>
                     <legend>Angaben zur RFID-Karten Folgebestellung für: '.$name.'</legend>  
                     <table>
                       <tr>
                         <td width="40%">Startklasse Formationen:<span class="mandatoryFieldMarker" title="Pflichtfeld">*</span><br><br><br><br><br><br></td>
                         <td>
                   ...
                   <br />                             
                    <fieldset>
                      ...
                      <table>
                       ...
                       <tr>
                         <td>Mailadresse:</td>
                         <td><input required type="text" name="MailDa" tabindex="10" size="55"><span class="mandatoryFieldMarker" title="Pflichtfeld">*</span></td>
                       </tr>  
                       <tr>
                         <td>Telefon/Handy:</td>
                 ...
                 echo '
                   <font face="Verdana" size="3" color="#000080"><br />  
                   <fieldset>
                     <legend>Angaben zur RFID-Karten Folgebestellung für: ';
                       if($memberrow[7]){
                ...
                echo'</legend>  
                   ...
                   <fieldset>
                     ...
                     <table>
                       ...
                       <tr>
                         <td>Vorname:</td>
                         <td><input required type="text" name="VornameHr" value="'.$memberrow[7].'" size="55" readonly="readonly"></td>
                       </tr>
                       <tr>
                         <td>Strasse:</td>
                 ...
                 echo '
                   ...
                   <fieldset>
                     ...
                     <table>
                       <tr>
                         <td width="40%">Startklasse Rock\'n\'Roll:<span class="mandatoryFieldMarker" title="Pflichtfeld">*</span><br><br><br><br><br></td>
                         <td>
                   ...
                   <fieldset>
                    ...
                    <fieldset>
                      <legend>Neue RFID-Karte</legend>
                      <table>
                       <tr>
                         <td width="50%">wird ben&ouml;tigt f&uuml;r:<span class="mandatoryFieldMarker" title="Pflichtfeld">*</span><br><br></td>
                         <td>
                           <input id="rfidDa" name="rfid" class="element radio" type="radio" value="Dame" />die Dame<br>
                           <input id="rfidHr" name="rfid" class="element radio" type="radio" value="Herr" />den Herrn<br>            
                           <input id="rfidBeide" name="rfid" class="element radio" type="radio" value="Beide" />Beide<br>            
                         </td>
                       </tr>  
                     </table>   
                   </fieldset>
