...
echo '         <form name="Formular" action="'.$g_root_path.'/adm_program/modules/forms/mail_send.php?form_id=13" method="post" autocomplete="off" accept-charset="UTF-8" onsubmit="return chkFormular()">
                  <!-- Hier die eigentlichen Formularfelder eintragen. Die folgenden sind Beispielangaben. -->                  
                  <font face="Verdana" size="3" color="#000080">
                  <h3>&nbsp;Turnier Reservierung</h3>
                  <br />
                  <fieldset>
                  ...
                  <br />
                  <fieldset>
                    <legend>Zu welchem Termin soll die Veranstaltung reserviert werden?</legend>
                    <table>
                      <tr>
                        <td>Datum:</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td><input type="text" name="VeranstaltungOrtsbezeichner" tabindex="19" size="55"></td>
                      </tr>
                      <tr>
                        <td>Straße:</td>
                        <td><input type="text" name="VeranstaltungStrasse" tabindex="20" size="55"></td>
                      </tr>
                      <tr>
                         <td>PLZ / Ort:</td>
                         <td>
                           <input type="text" name="VeranstaltungPLZ" tabindex="21" size="5" maxlength="5">
                           <input type="text" name="VeranstaltungOrt" tabindex="22" size="43">
                         </td>
                      </tr>
                      <tr>
                        <td valign=top>Beschreibung:</td>
                        <td valign=top><textarea name="VeranstaltungBeschreibung" rows="3" cols="40" tabindex="23">Nähere Infos zur Lokalität...</textarea></td>
                      </tr>
                    </table>    
                  </fieldset>
                  <br />
                  ...
                  <p>
                    <table>
                     <tr>
                        <td valign=top>
                          Die Reservierung gilt 8 Wochen und erlischt automatisch, sofern
                          keine Turnieranmeldung für den reservierten Termin erfolgt.<br /><br />
