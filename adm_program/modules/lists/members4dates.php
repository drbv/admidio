...
$gLayout['title']  = 'Teilnehmeranmeldung - '. $role->getValue('rol_name');
...
<script type="text/javascript"><!--
    ...
    //document.rmenkenForm.mem_search=="0_"
        ...
        $.post("'.$g_root_path.'/adm_program/modules/lists/members4dates_get.php?rol_id='.$getRoleId.'", $("#memsearch_form").serialize(), function(result){
...
require(SERVER_PATH. '/adm_program/system/overall_header.php');
  echo '<h1>Teilnehmeranmeldung<br>'.$role->getValue('rol_description').'</h1><br>';

// Meldeschluss pruefen
// ploepmeier: do not show content if registration is closed
...
if( $isCheckinPossible ) {
  //Suchleiste
  //rmenken: only for webmaster, because otherwise users can search and get all members instead only myowngroups
  ...
  $daySinceCheckindeadline = - $daysToCheckindeadline;
  $labelDays = $daySinceMeldeschluss == 1 ? "Tag" : "Tagen";
  echo "<h2>Meldeschluss ist seit $daySinceCheckindeadline $labelDays &uuml;berschritten.</h2>";
}
